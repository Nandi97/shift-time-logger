  ...
  return (
    <div className="mx-auto max-w-6xl p-6">
      <div className="mb-4 flex items-end justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold">Admin Reports (Bi-weekly)</h1>
          <p className="text-sm text-slate-600">
            Period: <b>{start}</b> → <b>{endEx}</b> (exclusive) —{' '}
            <code>{tz}</code>
          </p>
          <p className="text-sm text-slate-600">
            Entries show <b>Entry</b>, optional <b>LunchStart/LunchEnd</b>, and{' '}
            <b>Exit</b>. Hours are Entry→Exit (no lunch deduction).
          </p>
        </div>
